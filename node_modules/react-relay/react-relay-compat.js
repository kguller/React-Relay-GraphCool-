...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fbjs/lib/invariant"), require("react"), require("babel-runtime/helpers/classCallCheck"), require("babel-runtime/helpers/extends"), require("fbjs/lib/warning"), require("fbjs/lib/areEqual"), require("fbjs/lib/sprintf"), require("babel-runtime/helpers/inherits"), require("babel-runtime/helpers/possibleConstructorReturn"), require("prop-types"), require("relay-runtime"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/forEachObject"), require("fbjs/lib/nullthrows"), require("fbjs/lib/removeFromArray"), require("babel-runtime/helpers/defineProperty"), require("fbjs/lib/mapObject"), require("fbjs/lib/base62"));
	else if(typeof define === 'function' && define.amd)
		define(["fbjs/lib/invariant", "react", "babel-runtime/helpers/classCallCheck", "babel-runtime/helpers/extends", "fbjs/lib/warning", "fbjs/lib/areEqual", "fbjs/lib/sprintf", "babel-runtime/helpers/inherits", "babel-runtime/helpers/possibleConstructorReturn", "prop-types", "relay-runtime", "fbjs/lib/emptyFunction", "fbjs/lib/forEachObject", "fbjs/lib/nullthrows", "fbjs/lib/removeFromArray", "babel-runtime/helpers/defineProperty", "fbjs/lib/mapObject", "fbjs/lib/base62"], factory);
	else if(typeof exports === 'object')
		exports["ReactRelayCompat"] = factory(require("fbjs/lib/invariant"), require("react"), require("babel-runtime/helpers/classCallCheck"), require("babel-runtime/helpers/extends"), require("fbjs/lib/warning"), require("fbjs/lib/areEqual"), require("fbjs/lib/sprintf"), require("babel-runtime/helpers/inherits"), require("babel-runtime/helpers/possibleConstructorReturn"), require("prop-types"), require("relay-runtime"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/forEachObject"), require("fbjs/lib/nullthrows"), require("fbjs/lib/removeFromArray"), require("babel-runtime/helpers/defineProperty"), require("fbjs/lib/mapObject"), require("fbjs/lib/base62"));
	else
		root["ReactRelayCompat"] = factory(root["fbjs/lib/invariant"], root["react"], root["babel-runtime/helpers/classCallCheck"], root["babel-runtime/helpers/extends"], root["fbjs/lib/warning"], root["fbjs/lib/areEqual"], root["fbjs/lib/sprintf"], root["babel-runtime/helpers/inherits"], root["babel-runtime/helpers/possibleConstructorReturn"], root["prop-types"], root["relay-runtime"], root["fbjs/lib/emptyFunction"], root["fbjs/lib/forEachObject"], root["fbjs/lib/nullthrows"], root["fbjs/lib/removeFromArray"], root["babel-runtime/helpers/defineProperty"], root["fbjs/lib/mapObject"], root["fbjs/lib/base62"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_16__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_23__, __WEBPACK_EXTERNAL_MODULE_24__, __WEBPACK_EXTERNAL_MODULE_25__, __WEBPACK_EXTERNAL_MODULE_34__, __WEBPACK_EXTERNAL_MODULE_35__, __WEBPACK_EXTERNAL_MODULE_53__) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	module.exports = {
	  QueryRenderer: __webpack_require__(38),
	  applyOptimisticMutation: __webpack_require__(26).applyUpdate,
	  commitMutation: __webpack_require__(26).commitUpdate,
	  createFragmentContainer: __webpack_require__(40).createContainer,
	  ...
	  graphql: graphql,
	  injectDefaultVariablesProvider: __webpack_require__(12).injectDefaultVariablesProvider
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QueryBuilder = {
	  ...
	  createQuery: function createQuery(partialQuery) {
	    ...
	    if (identifyingArgName == null && __webpack_require__(29).isNodeRootCall(partialQuery.fieldName)) {
	      identifyingArgName = __webpack_require__(29).ID;
	    }
	    if (identifyingArgName != null) {
	      __webpack_require__(7)(partialQuery.identifyingArgValue != null, 'QueryBuilder.createQuery(): An argument value may be required for ' + 'query `%s(%s: ???)`.', partialQuery.fieldName, identifyingArgName);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayPropTypes = {
	  ...
	  Environment: function Environment(props, propName, componentName) {
	    ...
	    if (!__webpack_require__(20)(context) || !__webpack_require__(33)(context)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isRelayContext(context) {
	  return typeof context === 'object' && context !== null && !Array.isArray(context) && __webpack_require__(33)(context.environment) && __webpack_require__(51)(context.variables);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function buildCompatContainer(ComponentClass, fragmentSpec, createContainerWithFragments) {
	  ...
	  function getFragment(fragmentName, variableMapping) {
	    ...
	    var fragment = __webpack_require__(28).getClassicFragment(taggedNode);
	  ...
	  function hasVariable(variableName) {
	    return Object.keys(fragmentSpec).some(function (fragmentName) {
	      var fragment = __webpack_require__(28).getClassicFragment(fragmentSpec[fragmentName]);
	  ...
	  function ContainerConstructor(props, context) {
	    if (Container == null || context.relay.environment !== environment) {
	      ...
	      var _fragments = __webpack_require__(35)(fragmentSpec, getFragmentFromTag);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayProfiler = {
	  ...
	  instrumentMethods: function instrumentMethods(object, names) {
	    __webpack_require__(23)(names, function (name, key) {
	  ...
	  instrument: function instrument(name, originalFunction) {
	    ...
	    instrumentedCallback.detachHandler = function (handler) {
	      __webpack_require__(25)(handlers, handler);
	    };
	  ...
	  detachAggregateHandler: function detachAggregateHandler(name, handler) {
	    if (shouldInstrument(name)) {
	      if (aggregateHandlersByName.hasOwnProperty(name)) {
	        __webpack_require__(25)(aggregateHandlersByName[name], handler);
	      }
	    }
	  },
	  ...
	  detachProfileHandler: function detachProfileHandler(name, handler) {
	    if (shouldInstrument(name)) {
	      if (profileHandlersByName.hasOwnProperty(name)) {
	        __webpack_require__(25)(profileHandlersByName[name], handler);
	      }
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function profileContainer(Container, containerName) {
	  __webpack_require__(13).instrumentMethods(Container.prototype, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function commitRelayClassicMutation(environment, _ref) {
	  ...
	  if (typeof optimisticResponse === 'function') {
	    __webpack_require__(7)(false, 'RelayCompatMutations: Expected `optimisticResponse` to be an object, ' + 'received a function.');
	...
	function validateOptimisticResponse(operation, optimisticResponse) {
	  if (operation.node.kind === 'Mutation' && operation.node.calls && operation.node.calls.length === 1) {
	    ...
	    if (optimisticResponse[mutationRoot]) {
	      ...
	      __webpack_require__(7)(false, 'RelayCompatMutations: Expected result from `optimisticResponse`' + 'to contain the mutation name `%s` as a property, got `%s`', mutationRoot, optimisticResponse);
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayFragmentReference = function () {
	  ...
	  RelayFragmentReference.prototype.getVariables = function getVariables(route, variables) {
	    ...
	    if (variableMapping) {
	      __webpack_require__(23)(variableMapping, function (value, name) {
	        var callVariable = __webpack_require__(3).getCallVariable(value);
	        if (callVariable) {
	          value = variables[callVariable.callVariableName];
	        }
	        if (value === undefined) {
	          __webpack_require__(7)(false, 'RelayFragmentReference: Variable `%s` is undefined in fragment ' + '`%s`.', name, _this.getFragmentUnconditional().name);
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getClassicFragment(taggedNode) {
	  ...
	  return __webpack_require__(30).__getClassicFragment(taggedNode);
	}

	function getClassicOperation(taggedNode) {
	  // $FlowFixMe Property not found in `RelayQL`
	  return __webpack_require__(30).__getClassicOperation(taggedNode);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getResultsFromPayload(query, payload) {
	  ...
	  if (rootBatchCall) {
	    ...
	    __webpack_require__(49)(query, function (_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function assertValidFragment(substitution) {
	  __webpack_require__(1)(substitution instanceof __webpack_require__(27) || __webpack_require__(3).getFragment(substitution) || __webpack_require__(3).getFragmentSpread(substitution), 'RelayQL: Invalid fragment composition, use ' + "`${Child.getFragment('name')}`.");
	}
	...
	Object.assign(RelayQL, {
	  __frag: function __frag(substitution) {
	    if (typeof substitution === 'function') {
	      ...
	      return new (__webpack_require__(47))(substitution);
	    }
	  ...
	  __createFragment: function __createFragment(fragment, variableMapping) {
	    return new (__webpack_require__(27))(function () {
	      return fragment;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function assertFragmentMap(componentName, fragments) {
	  ...
	  __webpack_require__(23)(fragments, function (fragment, key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function generateConcreteFragmentID() {
	  return __webpack_require__(53)(_nextFragmentID++) + SUFFIX;
	}
	  ...
	  var Container = function (_React$Component) {
	    ...
	    function Container(props, context) {
	      ...
	      _this._handleFragmentDataUpdate = function () {
	        ...
	        var profiler = __webpack_require__(13).profile('ReactRelayFragmentContainer.handleFragmentDataUpdate');
	    ...
	    Container.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps, nextContext) {
	      var context = __webpack_require__(24)(nextContext);
	      var relay = assertRelayContext(context.relay);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperty3 = _interopRequireDefault(__webpack_require__(34));
	...
	function findConnectionMetadata(fragments) {
	  ...
	  if (isRelayModern) {
	    __webpack_require__(7)(foundConnectionMetadata !== null, 'ReactRelayPaginationContainer: A @connection directive must be present.');
	  }
	...
	function createContainerWithFragments(Component, fragments, connectionConfig) {
	  ...
	  var Container = function (_React$Component) {
	    ...
	    function Container(props, context) {
	      ...
	      _this._handleFragmentDataUpdate = function () {
	        var profiler = __webpack_require__(13).profile('ReactRelayPaginationContainer.handleFragmentDataUpdate');
	      ...
	      _this._refetchConnection = function (totalCount, callback, refetchVariables) {
	        var paginatingVariables = {
	          count: totalCount,
	          cursor: null,
	          totalCount: totalCount
	        };
	        return _this._fetchPage(paginatingVariables, callback, { force: true }, refetchVariables);
	      };
	    ...
	    Container.prototype._getConnectionData = function _getConnectionData() {
	      ...
	      if (typeof hasMore !== 'boolean' || typeof cursor !== 'string') {
	        __webpack_require__(7)(false, 'ReactRelayPaginationContainer: Cannot paginate without %s fields in `%s`. ' + 'Be sure to fetch %s (got `%s`) and %s (got `%s`).', PAGE_INFO, componentName, direction === FORWARD ? HAS_NEXT_PAGE : HAS_PREV_PAGE, hasMore, direction === FORWARD ? END_CURSOR : START_CURSOR, cursor);
	        return null;
	      }
	      return {
	        cursor: cursor,
	    ...
	    Container.prototype._fetchPage = function _fetchPage(paginatingVariables, callback, options, refetchVariables) {
	      var _this2 = this;
	      ...
	      var onCompleted = function onCompleted() {
	        ...
	        if (!__webpack_require__(10)(prevData, nextData)) {
	          _this2.setState({ data: nextData }, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactRelayQueryRenderer = function (_React$Component) {
	  ...
	  ReactRelayQueryRenderer.prototype.render = function render() {
	    ...
	    if (true) {
	      __webpack_require__(48)(this.state.readyState);
	    }
	...
	function createContainerWithFragments(Component, fragments, taggedNode) {
	  ...
	  var Container = function (_React$Component) {
	    ...
	    function Container(props, context) {
	      ...
	      _this._handleFragmentDataUpdate = function () {
	        var profiler = __webpack_require__(13).profile('ReactRelayRefetchContainer.handleFragmentDataUpdate');
	        _this.setState({ data: _this._resolver.resolve() }, profiler.stop);
	      };
	      ...
	      _this._refetch = function (refetchVariables, renderVariables, callback, options) {
	        ...
	        var onNext = function onNext(response) {
	          ...
	          _this.setState({ data: _this._resolver.resolve() }, function () {
	            return callback && callback();
	          });
	        };
	        var onError = function onError(error) {
	        ...
	        _this._isARequestInFlight = true;
	        var pendingRefetch = environment.streamQuery({
	          cacheConfig: cacheConfig,
	          onError: onError,
	          onNext: onNext,
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	function createContainer(Component, fragmentSpec) {
	  return buildCompatContainer(Component, fragmentSpec, __webpack_require__(36).createContainerWithFragments);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createContainer(Component, fragmentSpec, connectionConfig) {
	  var Container = buildCompatContainer(Component, fragmentSpec, function (ComponentClass, fragments) {
	    return __webpack_require__(37).createContainerWithFragments(ComponentClass, fragments, connectionConfig);
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createContainer(Component, fragmentSpec, taggedNode) {
	  var Container = buildCompatContainer(Component, fragmentSpec, function (ComponentClass, fragments) {
	    return __webpack_require__(39).createContainerWithFragments(ComponentClass, fragments, taggedNode);
	  });
	  Container.childContextTypes = {
	    relay: __webpack_require__(4).Relay
	  };
