...
function createContainerComponent(Component, spec) {
  ...
  var RelayContainer = function (_React$Component) {
    ...
    function RelayContainer(props, context) {
      ...
      require('fbjs/lib/invariant')(require('./isClassicRelayContext')(relay), 'RelayContainer: `%s` was rendered with invalid Relay context `%s`. ' + 'Make sure the `relay` property on the React context conforms to the ' + '`RelayEnvironment` interface.', containerName, relay);
    ...
    RelayContainer.prototype._updateFragmentPointers = function _updateFragmentPointers(props, context, variables, prevVariables) {
      ...
      fragmentNames.forEach(function (fragmentName) {
        ...
        if (fragment.isPlural()) {
          ...
          if (_dataIDs2) {
            require('fbjs/lib/invariant')(_dataIDs2.length === propValue.length, 'RelayContainer: Invalid prop `%s` supplied to `%s`. Some ' + 'array items contain data fetched by Relay and some items ' + 'contain null/mock data.', fragmentName, componentName);
          }
    ...
    RelayContainer.prototype._getQueryData = function _getQueryData(props) {
      ...
      require('fbjs/lib/forEachObject')(this._fragmentResolvers, function (fragmentResolver, propName) {
        ...
        if (!propValue || !fragmentPointer) {
          ...
          require('fbjs/lib/invariant')(fragmentResolver, 'fragmentResolver should not be null');
