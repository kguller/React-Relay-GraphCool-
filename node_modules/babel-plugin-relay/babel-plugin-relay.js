	...
	function createSubstitutionsForFragmentSpreads(t, path, fragments) {
	  return Object.keys(fragments).map(function (varName) {
	    ...
	    if (!fragment.isMasked) {
	      __webpack_require__(3)(path.scope.hasBinding(module), 'BabelPluginRelay: Please make sure module %s is imported and not renamed. ' + module);
	      var fragmentProp = t.memberExpression(t.identifier(module), t.identifier(propName));
