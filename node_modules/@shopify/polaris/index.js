...
function renderSection(section, hasMultipleSections, index) {
    ...
    var className = section.title ? null : styles$11['Section-withoutTitle'];
...
function ChoiceList$1(_ref) {
    ...
    var choicesMarkup = choices.map(function (choice) {
        ...
        return React.createElement(
            'li',
            { key: value },
            React.createElement(ControlComponent, { name: finalName, value: value, label: label, checked: choiceIsSelected(choice, selected), helpText: helpText, onChange: handleChange })
        );
    });
    return React.createElement(
        'fieldset',
...
var Scrollable$1 = function (_React$Component) {
    ...
    _createClass(Scrollable, [{
        ...
        value: function render() {
            ...
            var finalClassName = _shopify_reactUtilities_styles.classNames(className, styles$37.Scrollable, vertical && styles$37.vertical, horizontal && styles$37.horizontal, topShadow && styles$37.hasTopShadow, bottomShadow && styles$37.hasBottomShadow);
            return React.createElement(
                'div',
        ...
        value: function forNode(node) {
            return _shopify_javascriptUtilities_dom.closest(node, scrollable.selector) || document;
        }
    }]);
    ...
    _createClass(PositionedOverlay, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(EventListener$1, { event: 'scroll', handler: this.handleMeasurement }),
        ...
        value: function handleMeasurement() {
            ...
            this.setState({
                ...
                var currentOverlayRect = _shopify_javascriptUtilities_geometry.getRectForNode(_this2.overlay);
                var scrollableElement = isDocument(_this2.scrollableContainer) ? document.body : _this2.scrollableContainer;
                var scrollableContainerRect = _shopify_javascriptUtilities_geometry.getRectForNode(scrollableElement);
...
function intersectionWithViewport(rect) {
    ...
    return new _shopify_javascriptUtilities_geometry.Rect({
...
function Pane(_ref) {
    ...
    var className = _shopify_reactUtilities_styles.classNames(styles$39.Pane, fixed && styles$39['Pane-fixed']);
...
var PopoverOverlay = function (_React$PureComponent) {
    ...
    _createClass(PopoverOverlay, [{
        ...
        value: function render() {
            ...
            var selector = '.' + styles$39.Popover;
        ...
        value: function renderPopover(transitionStatus, overlayDetails) {
            ...
            var className = _shopify_reactUtilities_styles.classNames(styles$39.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$39.positionedAbove, fullWidth && styles$39.fullWidth, measuring && styles$39.measuring);
            this.transitionStatus = transitionStatus;
            var tipMarkup = !measuring ? React.createElement('div', { style: { left: activatorRect.center.x - left }, className: styles$39.Tip }) : null;
            ...
            return React.createElement(
                ...
                tipMarkup,
                React.createElement('div', { className: styles$39.FocusTracker, tabIndex: 0, onFocus: this.handleFocusFirstItem }),
                React.createElement(
                    'div',
                    { className: styles$39.Wrapper },
                    content
                ),
                React.createElement('div', { className: styles$39.FocusTracker, tabIndex: 0, onFocus: this.handleFocusLastItem })
            );
        }
    }, {
        key: 'setContentNode',
        ...
        value: function handleClick(event) {
            ...
            if (contentNode != null && _shopify_javascriptUtilities_dom.nodeContainsDescendant(contentNode, target) || _shopify_javascriptUtilities_dom.nodeContainsDescendant(activator, target) || this.transitionStatus !== _shopify_reactUtilities_animation.TransitionStatus.Shown) {
                return;
            }
        ...
        value: function renderSecondaryActions() {
            ...
            var rollupMarkup = this.hasRollup ? React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(ActionList$1, { items: secondaryActions, sections: actionGroups.map(convertActionGroupToActionListSection) })
                )
            ) : null;
            return React.createElement(
                'div',
...
tslib_1.__decorate([autobind], Header$1.prototype, "handleRollupToggle", null);
...
var Page$1 = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = _shopify_reactUtilities_styles.classNames(styles$40.Page, fullWidth && styles$40.fullWidth);
    ...
    _createClass(TabMeasurer, [{
        ...
        value: function render() {
            ...
            var tabsMarkup = tabs.map(function (tab, index) {
                return React.createElement(
                    Tab,
                    { measuring: true, key: '' + index + tab.id + 'Hidden', id: tab.id + 'Measurer', siblingTabHasFocus: siblingTabHasFocus, focused: index === tabToFocus, selected: index === selected, onClick: _shopify_javascriptUtilities_other.noop, url: tab.url },
                    tab.title
                );
            });
    ...
    _createClass(Tabs, [{
        ...
        value: function handleTabClick(id) {
            var _props4 = this.props,
                ...
                onSelect = _props4$onSelect === undefined ? _shopify_javascriptUtilities_other.noop : _props4$onSelect;
...
var TextField$1 = function (_React$PureComponent) {
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            ...
            var spinnerMarkup = type === 'number' && !disabled ? React.createElement(Spinner, { onClick: this.handleInputFocus, onChange: this.handleNumberChange }) : null;
