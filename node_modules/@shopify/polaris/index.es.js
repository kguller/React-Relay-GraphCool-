...
var Scrollable$1 = function (_React$Component) {
    ...
    _createClass(Scrollable, [{
        ...
        value: function render() {
            ...
            var finalClassName = classNames(className, styles$37.Scrollable, vertical && styles$37.vertical, horizontal && styles$37.horizontal, topShadow && styles$37.hasTopShadow, bottomShadow && styles$37.hasBottomShadow);
            return createElement(
                'div',
...
function Pane(_ref) {
    ...
    var className = classNames(styles$39.Pane, fixed && styles$39['Pane-fixed']);
...
var PopoverOverlay = function (_React$PureComponent) {
    ...
    _createClass(PopoverOverlay, [{
        ...
        value: function renderPopover(transitionStatus, overlayDetails) {
            ...
            var className = classNames(styles$39.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$39.positionedAbove, fullWidth && styles$39.fullWidth, measuring && styles$39.measuring);
            this.transitionStatus = transitionStatus;
            var tipMarkup = !measuring ? createElement('div', { style: { left: activatorRect.center.x - left }, className: styles$39.Tip }) : null;
...
var Page$1 = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$40.Page, fullWidth && styles$40.fullWidth);
...
var TextField$1 = function (_React$PureComponent) {
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            ...
            var spinnerMarkup = type === 'number' && !disabled ? createElement(Spinner, { onClick: this.handleInputFocus, onChange: this.handleNumberChange }) : null;
