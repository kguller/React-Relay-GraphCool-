...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fbjs/lib/invariant"), require("fbjs/lib/warning"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/forEachObject"), require("babel-runtime/helpers/extends"), require("fbjs/lib/areEqual"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/removeFromArray"), require("babel-runtime/helpers/defineProperty"), require("babel-runtime/helpers/toConsumableArray"), require("fbjs/lib/mapObject"), require("fbjs/lib/nullthrows"), require("fbjs/lib/resolveImmediate"), require("fbjs/lib/sprintf"));
	else if(typeof define === 'function' && define.amd)
		define(["fbjs/lib/invariant", "fbjs/lib/warning", "babel-runtime/helpers/classCallCheck", "fbjs/lib/forEachObject", "babel-runtime/helpers/extends", "fbjs/lib/areEqual", "fbjs/lib/emptyFunction", "fbjs/lib/removeFromArray", "babel-runtime/helpers/defineProperty", "babel-runtime/helpers/toConsumableArray", "fbjs/lib/mapObject", "fbjs/lib/nullthrows", "fbjs/lib/resolveImmediate", "fbjs/lib/sprintf"], factory);
	else if(typeof exports === 'object')
		exports["RelayRuntime"] = factory(require("fbjs/lib/invariant"), require("fbjs/lib/warning"), require("babel-runtime/helpers/classCallCheck"), require("fbjs/lib/forEachObject"), require("babel-runtime/helpers/extends"), require("fbjs/lib/areEqual"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/removeFromArray"), require("babel-runtime/helpers/defineProperty"), require("babel-runtime/helpers/toConsumableArray"), require("fbjs/lib/mapObject"), require("fbjs/lib/nullthrows"), require("fbjs/lib/resolveImmediate"), require("fbjs/lib/sprintf"));
	else
		root["RelayRuntime"] = factory(root["fbjs/lib/invariant"], root["fbjs/lib/warning"], root["babel-runtime/helpers/classCallCheck"], root["fbjs/lib/forEachObject"], root["babel-runtime/helpers/extends"], root["fbjs/lib/areEqual"], root["fbjs/lib/emptyFunction"], root["fbjs/lib/removeFromArray"], root["babel-runtime/helpers/defineProperty"], root["babel-runtime/helpers/toConsumableArray"], root["fbjs/lib/mapObject"], root["fbjs/lib/nullthrows"], root["fbjs/lib/resolveImmediate"], root["fbjs/lib/sprintf"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_29__, __WEBPACK_EXTERNAL_MODULE_30__, __WEBPACK_EXTERNAL_MODULE_31__, __WEBPACK_EXTERNAL_MODULE_64__, __WEBPACK_EXTERNAL_MODULE_65__, __WEBPACK_EXTERNAL_MODULE_66__, __WEBPACK_EXTERNAL_MODULE_67__, __WEBPACK_EXTERNAL_MODULE_68__, __WEBPACK_EXTERNAL_MODULE_69__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  // Core API
	  Environment: __webpack_require__(45),
	  Network: __webpack_require__(48),
	  Observable: __webpack_require__(20),
	  QueryResponseCache: __webpack_require__(51),
	  RecordSource: __webpack_require__(12),
	  Store: __webpack_require__(44),
	  ...
	  // Extensions
	  ConnectionHandler: __webpack_require__(10),
	  ViewerHandler: __webpack_require__(36),

	  // Helpers (can be implemented via the above API)
	  applyOptimisticMutation: __webpack_require__(55),
	  commitLocalUpdate: __webpack_require__(56),
	  commitMutation: __webpack_require__(57),
	  fetchQuery: __webpack_require__(58),
	  isRelayModernEnvironment: __webpack_require__(26),
	  requestSubscription: __webpack_require__(62)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function update(prevRecord, nextRecord) {
	  ...
	  for (var ii = 0; ii < keys.length; ii++) {
	    var key = keys[ii];
	    if (updated || !__webpack_require__(29)(prevRecord[key], nextRecord[key])) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getStorageKey(field, variables) {
	  ...
	  args.forEach(function (arg) {
	    ...
	    if (value != null) {
	      values.push('"' + arg.name + '":' + __webpack_require__(28)(value));
	    }
	  });
	  if (values.length) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createFragmentSpecResolver(context, containerName, fragments, props, callback) {
	  ...
	  return new (__webpack_require__(46))(context, fragments, props, callback);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function normalizeRelayPayload(selector, payload, errors) {
	  ...
	  var fieldPayloads = __webpack_require__(54).normalize(source, selector, payload, options);
	  return {
	    errors: errors,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayObservable = function () {
	  ...
	  RelayObservable.from = function from(obj) {
	    return isObservable(obj) ? fromObservable(obj) : __webpack_require__(25)(obj) ? fromPromise(obj) : obj instanceof Error ? fromError(obj) : fromValue(obj);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecordInspector = function () {
	  ...
	  RecordInspector.prototype.inspect = function inspect() {
	    return __webpack_require__(63)(this._record);
	  };
	...
	var RelayRecordSourceProxy = function () {
	  ...
	  RelayRecordSourceProxy.prototype.get = function get(dataID) {
	    if (!this._proxies.hasOwnProperty(dataID)) {
	      ...
	      if (status === EXISTENT) {
	        this._proxies[dataID] = new (__webpack_require__(52))(this, this.__mutator, dataID);
	      } else {
	      ...
	      if (parent) {
	        ...
	        try {
	          for (var _iterator = connectionInfo[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            if (serverEdge) {
	              var connection = __webpack_require__(10).getConnection(parent, info.key, info.filters);
	              if (!connection) {
	                return;
	              }
	              var clientEdge = __webpack_require__(10).buildConnectionEdge(store, connection, serverEdge);
	              if (!clientEdge) {
	                return;
	              }
	              switch (info.rangeBehavior) {
	                case 'append':
	                  __webpack_require__(10).insertEdgeAfter(connection, clientEdge);
	                  break;
	                case 'ignore':
	                  // Do nothing
	                  break;
	                case 'prepend':
	                  __webpack_require__(10).insertEdgeBefore(connection, clientEdge);
	                  break;
	                default:
	    ...
	    if (connectionKeys && recordProxy) {
	      ...
	      try {
	        var _loop = function _loop() {
	          ...
	          var connection = __webpack_require__(10).getConnection(recordProxy, key.key, key.filters);
	          if (connection) {
	            deleteIDs.forEach(function (deleteID) {
	              __webpack_require__(10).deleteNode(connection, deleteID);
	            });
	            return 'break';
	          }
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayDataLoader = function () {
	  function RelayDataLoader(source, target, variables, handlers) {
	    ...
	    this._mutator = new (__webpack_require__(17))(source, target);
	  }
	    ...
	    selections.every(function (selection) {
	      switch (selection.kind) {
	        ...
	        case LINKED_HANDLE:
	          ...
	          var handleField = __webpack_require__(37)(selection, selections, _this2._variables);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function areEqualSelectors(thisSelector, thatSelector) {
	  return thisSelector.dataID === thatSelector.dataID && thisSelector.node === thatSelector.node && __webpack_require__(29)(thisSelector.variables, thatSelector.variables);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NOT_INVOKED = {};
	var defaultProfiler = { stop: __webpack_require__(30) };
	...
	var RelayProfiler = {
	  ...
	  instrument: function instrument(name, originalFunction) {
	    if (!shouldInstrument(name)) {
	      originalFunction.attachHandler = __webpack_require__(30);
	      originalFunction.detachHandler = __webpack_require__(30);
	    ...
	    instrumentedCallback.detachHandler = function (handler) {
	      __webpack_require__(31)(handlers, handler);
	    };
	  ...
	  detachAggregateHandler: function detachAggregateHandler(name, handler) {
	    if (shouldInstrument(name)) {
	      if (aggregateHandlersByName.hasOwnProperty(name)) {
	        __webpack_require__(31)(aggregateHandlersByName[name], handler);
	      }
	    }
	  },
	  ...
	  detachProfileHandler: function detachProfileHandler(name, handler) {
	    if (shouldInstrument(name)) {
	      if (profileHandlersByName.hasOwnProperty(name)) {
	        __webpack_require__(31)(profileHandlersByName[name], handler);
	      }
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function cloneRelayHandleSourceField(handleField, selections, variables) {
	  var sourceField = selections.find(function (source) {
	    return source.kind === LINKED_FIELD && source.name === handleField.name && source.alias === handleField.alias && __webpack_require__(29)(source.args, handleField.args);
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function normalizePayload(operation, variables, payload) {
	  ...
	  var error = __webpack_require__(43).create('RelayNetwork', 'No data returned for operation `%s`, got error(s):\n%s\n\nSee the error ' + '`source` property for more information.', operation.name, errors ? errors.map(function (_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toConsumableArray3 = _interopRequireDefault(__webpack_require__(65));
	...
	function createError(type, name, format, args) {
	  ...
	  var error = new Error(__webpack_require__(69).apply(undefined, [format].concat((0, _toConsumableArray3['default'])(args))));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayMarkSweepStore = function () {
	  ...
	  RelayMarkSweepStore.prototype.check = function check(selector) {
	    return __webpack_require__(33).check(this._recordSource, this._recordSource, selector, []);
	  };
	  ...
	  RelayMarkSweepStore.prototype._updateSubscription = function _updateSubscription(subscription) {
	    ...
	    if (!__webpack_require__(59)(snapshot, this._updatedRecordIDs)) {
	      return;
	    }
	    ...
	    var nextData = __webpack_require__(61)(snapshot.data, data);
	  ...
	  RelayMarkSweepStore.prototype._scheduleGC = function _scheduleGC() {
	    ...
	    __webpack_require__(68)(function () {
	      _this4._gc();
	  ...
	  RelayMarkSweepStore.prototype._gc = function _gc() {
	    ...
	    this._roots.forEach(function (selector) {
	      __webpack_require__(53).mark(_this5._recordSource, selector, references);
	    });
	...
	__webpack_require__(35).instrumentMethods(RelayMarkSweepStore.prototype, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayModernEnvironment = function () {
	  function RelayModernEnvironment(config) {
	    ...
	    var handlerProvider = config.handlerProvider ? config.handlerProvider : __webpack_require__(42);
	    this._network = config.network;
	    this._publishQueue = new (__webpack_require__(50))(config.store, handlerProvider);
	  ...
	  RelayModernEnvironment.prototype.sendQuery = function sendQuery(_ref2) {
	    ...
	    if (__webpack_require__(25)(networkRequest)) {
	  ...
	  RelayModernEnvironment.prototype._recordDebuggerEvent = function _recordDebuggerEvent(_ref6) {
	    var eventName = _ref6.eventName,
	        mutationUid = _ref6.mutationUid,
	  ...
	  RelayModernEnvironment.prototype.checkSelectorAndUpdateStore = function checkSelectorAndUpdateStore(selector, handlers) {
	    ...
	    var result = __webpack_require__(33).check(this._store.getSource(), target, selector, handlers);
	    if (target.size() > 0) {
	    ...
	    if (this._stale) {
	      ...
	      __webpack_require__(8)(this._resolvers, function (resolver, key) {
	        ...
	        if (resolver) {
	          ...
	          if (nextData || !__webpack_require__(60)(_nextItem, prevItem)) {
	            nextData = nextData || (0, _extends3['default'])({}, prevData);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function create(fetch, subscribe) {
	  ...
	  function request(operation, variables, cacheConfig, uploadables) {
	    return observeFetch(fetch, operation, variables, cacheConfig, uploadables).map(function (payload) {
	      return __webpack_require__(38)(operation, variables, payload);
	    }).toPromise().then(__webpack_require__(67));
	  }
	...
	function observeFetch(fetch, operation, variables, cacheConfig, uploadables) {
	  ...
	  return __webpack_require__(20).from(result);
	}
	...
	function observeStream(fetch, subscribe, operation, variables, cacheConfig, uploadables) {
	  ...
	  if (operation.query.operation === 'subscription') {
	    __webpack_require__(1)(subscribe_, 'The default network layer does not support GraphQL Subscriptions. ' + 'To use Subscriptions, provide a custom network layer.');

	    __webpack_require__(1)(!uploadables, 'Cannot provide uploadables while subscribing.');

	    return __webpack_require__(20).fromLegacy(function (observer) {
	  ...
	  if (pollInterval != null) {
	    __webpack_require__(1)(!uploadables, 'Cannot provide uploadables while polling.');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperty3 = _interopRequireDefault(__webpack_require__(64));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayPublishQueue = function () {
	  ...
	  RelayPublishQueue.prototype._getSourceFromPayload = function _getSourceFromPayload(payload) {
	    ...
	    var mutator = new (__webpack_require__(17))(this._store.getSource(), source);
	  ...
	  RelayPublishQueue.prototype._commitUpdaters = function _commitUpdaters() {
	    ...
	    this._pendingUpdaters.forEach(function (updater) {
	      var mutator = new (__webpack_require__(17))(_this3._store.getSource(), sink);
	      var store = new (__webpack_require__(23))(mutator);
	      updater(store);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getCacheKey(queryID, variables) {
	  return __webpack_require__(28)({ queryID: queryID, variables: variables });
	}
	  ...
	  RelayReferenceMarker.prototype._traverseSelections = function _traverseSelections(selections, record) {
	    ...
	    selections.forEach(function (selection) {
	      if (selection.kind === LINKED_FIELD) {
	        ...
	        // it was split from.
	        var handleField = __webpack_require__(37)(selection, selections, _this._variables);
	        if (handleField.plural) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	normalize = __webpack_require__(35).instrument('RelayResponseNormalizer.normalize', normalize);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function applyRelayModernOptimisticMutation(environment, config) {
	  __webpack_require__(1)(__webpack_require__(26)(environment), 'commitRelayModernMutation: expect `environment` to be an instance of ' + '`RelayModernEnvironment`.');
	  ...
	  if (configs) {
	    var _setRelayModernMutati = __webpack_require__(27)(configs, mutation, optimisticUpdater);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function commitRelayModernMutation(environment, config) {
	  ...
	  if (configs) {
	    var _setRelayModernMutati = __webpack_require__(27)(configs, mutation, optimisticUpdater, updater);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function requestRelaySubscription(environment, config) {
	  ...
	  if (configs) {
	    var _setRelayModernMutati = __webpack_require__(27)(configs, subscription, null /* optimisticUpdater */
	    , updater);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function simpleClone(value) {
	  if (Array.isArray(value)) {
	    ...
	    return __webpack_require__(66)(value, simpleClone);
	  } else {
	    return value;
	  }
	}
