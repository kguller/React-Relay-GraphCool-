...
var RelayNetworkLoggerTransaction = function () {
  ...
  RelayNetworkLoggerTransaction.prototype.commitLogs = function commitLogs(error, response, status) {
    ...
    this.getLogsToCommit(error, response, status).forEach(function (_ref2) {
      var _console;
  ...
  RelayNetworkLoggerTransaction.prototype.getLogsToCommit = function getLogsToCommit(error, response, status) {
    return this._logs;
  };
